  ...
  return (
    <nav className="fixed z-50 w-full bg-white shadow-sm">
      <div className="flex items-center justify-between px-4 py-3 lg:px-8 lg:py-4">
        ...
        <Link
          href="/"
          className="no-underline flex flex-col leading-none font-mont"
        >
          <span
        ...
        <ul className="hidden lg:flex items-center gap-10">
          ...
          <li>
            <Link href="/contact">
              <Button className="bg-main text-white font-mont text-sm">
                Contact Us
              </Button>
            </Link>
          </li>
      ...
      {open && (
        <div className="lg:hidden fixed inset-0 z-40 bg-main flex flex-col">
          ...
          <div className="flex items-center justify-between px-4 py-3">
            ...
            >
              <span
                className="font-extrabold tracking-[2px] text-[1.1rem] font-quick"
                style={{
                  background:
                    "linear-gradient(135deg, #c8920a 0%, #f5d97a 40%, #e2a91a 60%, #b07c0a 100%)",
                  WebkitBackgroundClip: "text",
              ...
              <div className="flex items-center gap-1.5 mt-1">
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(90deg, #c8920a, #f5d97a, #c8920a)",
                  }}
                />
                <span
          ...
          <ul className="flex flex-col divide-y divide-white/10 mt-4">
            ...
            <li className="px-5 py-5 flex justify-end">
              <Link href="/contact" onClick={() => setOpen(false)}>
                <Button className="bg-white text-main font-mont font-semibold">
                  Contact Us
                </Button>
              </Link>
            </li>
